          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center">
              <Link href="/user/profile">
                <span className="ml-4 text-white cursor-pointer">profile</span>
              </Link>
              <Link href="/user/settings">
                <span className="ml-4 text-white cursor-pointer">setings</span>
              </Link>
              <Link href="/login">
                <span className="ml-4 text-white cursor-pointer">Login</span>
              </Link>
              <Link href="/register">
